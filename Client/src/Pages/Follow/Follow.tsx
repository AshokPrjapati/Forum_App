                ...
                following.map((Following: any) => (
                  ...
                  >
                    <Flex w="100%" alignItems={"center"} gap="10px" p="10px">
                      <Avatar
                        as={Link}
                        to={`/user/${Following?.followingID._id}`}
                        bg="purple.400"
                        color="blackAlpha.800"
                        boxSize="45px"
                        name={Following?.followingID?.username}
                        src={
                          Following?.followingID?.photoURL ||
                      ...
                      <Box as={Link} to={`/user/${Following?.followingID._id}`}>
                        ...
                        <Text textTransform={"capitalize"} fontWeight={"400"}>
                          {Following?.followingID?.bio ||
                            Following?.followingID?.email}
                        </Text>
                      </Box>
                      <Box ml="auto">
                        <Button
                ...
                followers.map((follower: any) => (
                  ...
                  >
                    <Flex w="100%" alignItems={"center"} gap="10px" p="10px">
                      <Avatar
                        as={Link}
                        to={`/user/${follower?.userID?._id}`}
                        bg="purple.400"
                        color="blackAlpha.800"
                        boxSize="45px"
                        name={follower?.userID?.username}
                        src={
                          follower?.userID?.photoURL ||
                          "https://bit.ly/dan-abramov"
                        }
                      />
                      <Box as={Link} to={`/user/${follower?.userID?._id}`}>
                        ...
                        <Text textTransform={"capitalize"} fontWeight={"400"}>
                          {follower?.userID?.bio || follower?.userID?.email}
                        </Text>
                      </Box>
                      <Box ml="auto">
                        <Button
