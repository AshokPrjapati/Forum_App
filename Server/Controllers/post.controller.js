...
async function AllPost(req, res) {
  try {
    ...
    res
      .status(200)
      .json({ status: 200, posts, message: "all post has been sent." });
  } catch (error) {
    console.log("error: ", error);
    res.send(error);
  }
...
async function UnLikePost(req, res) {
  ...
  try {
    ...
    res
      .status(201)
      .json({ status: 200, message: "Like has been deleted.", likes });
  } catch (error) {
    console.log("error: ", error);
    res.send(error);
  }
...
async function GetPostLikes(req, res) {
  ...
  try {
    ...
    return res
      .status(201)
      .json({ status: 200, message: "Likes list of user .", likes });
  } catch (error) {
    console.log("error: ", error);
